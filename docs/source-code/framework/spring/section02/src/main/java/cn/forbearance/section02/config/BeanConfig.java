package cn.forbearance.section02.config;

import cn.forbearance.section02.bean.Book;
...
@ComponentScans(value = {
        @ComponentScan(value = "cn.forbearance.section02", includeFilters = {
                /*
        ...
        @ComponentScan(value = "cn.forbearance.section02", excludeFilters = {
                /*
                 * type: 指定要排除的规则，按照注解进行排除、or 按照给定的类型进行配出、等等...
